  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-background overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-1/2 h-100 w-100 -translate-x-1/2 -translate-y-1/2 rounded-full bg-linear-to-r from-primary/40 via-purple-500/30 to-cyan-500/40 blur-3xl animate-pulse" />
      </div>
